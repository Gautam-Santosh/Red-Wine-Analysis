...
Open `Red\_Wine\_Analysis.ipynb` and run all cells. ✅
...
├── 📓 Red\_Wine\_documented.ipynb        # Main notebook (with explanations)
...
&#x20;   ├── cluster\_profiles.csv            # Average chemistry per cluster

&#x20;   ├── quality\_drivers.csv             # Top features driving quality

&#x20;   ├── wines\_clustered.csv             # Each wine with its cluster

&#x20;   └── wine\_quality\_model.pkl          # Trained Random Forest model
